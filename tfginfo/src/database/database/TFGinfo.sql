...
CREATE TABLE `career` (
  ...
  `double_career` smallint NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
INSERT INTO `career` VALUES (9,14,'Ingeniería del Software',0),(13,16,'Matemáticas',0),(25,NULL,'Doble grado en Ingeniería del Software y Matemáticas',1);
...
--
-- Table structure for table `double_career`
--

DROP TABLE IF EXISTS `double_career`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `double_career` (
  `id` int NOT NULL AUTO_INCREMENT,
  `career` int NOT NULL,
  `primary_career` int NOT NULL,
  `secondary_career` int NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  UNIQUE KEY `career_UNIQUE` (`career`),
  KEY `Primary_career_idx` (`primary_career`),
  KEY `Secondary_career_idx` (`secondary_career`),
  CONSTRAINT `Double_career` FOREIGN KEY (`career`) REFERENCES `career` (`id`),
  CONSTRAINT `Primary_career` FOREIGN KEY (`primary_career`) REFERENCES `career` (`id`),
  CONSTRAINT `Secondary_career` FOREIGN KEY (`secondary_career`) REFERENCES `career` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `double_career`
--

LOCK TABLES `double_career` WRITE;
/*!40000 ALTER TABLE `double_career` DISABLE KEYS */;
INSERT INTO `double_career` VALUES (1,25,9,13);
/*!40000 ALTER TABLE `double_career` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `professor` VALUES (31,'profesor1@gmail.com','Profesor','LCC',14,0,80);
...
INSERT INTO `student` VALUES (41,'alumno1@gmail.com','Alumno','Software','12312312A',9,'','',NULL,79);
...
INSERT INTO `tfg_line` VALUES (21,'Aplicación Full Stack','Desarrollo de una aplicación Full Stack. Involucra el diseño de una base de datos, desarrollo de una API Rest y de una aplicación web.',10,0,14);
...
INSERT INTO `tfg_line_career` VALUES (46,21,9);
...
INSERT INTO `tfg_line_professor` VALUES (19,21,31);
...
INSERT INTO `university` VALUES (14,'Escuela Técnica Superior de Ingeniería Informática','C/etsii N2','ETSII'),(15,'Escuela Técnica Superior de Ingeniería en Telecomunicaciones','C/etsit N2','ETSIT'),(16,'Ciencias','C/ciencias N2','');
...
INSERT INTO `university_department` VALUES (37,14,14),(38,15,14),(46,14,19),(47,15,19),(48,16,19);
...
INSERT INTO `user` VALUES (34,'sa@gmail.com','TPaCmqk3KOjzyX35E/sb+pX+WBDikzoFlD+DEqmNnPI=',1,NULL),(79,'alumno1@gmail.com','uWPECnTUOU7HRhiPgAsKJeca5d+vp5AFmiYgPZnqTis=',3,NULL),(80,'profesor1@gmail.com','xf6t2pXxXAgYZkHsIXv946whEpjxkSeYYQ72Uyx//h8=',2,NULL);
...
INSERT INTO `working_group` VALUES (31,'Canal 1',1,'Canal LCC');
...
INSERT INTO `working_group_professor` VALUES (37,31,31);
...
INSERT INTO `working_group_student` VALUES (33,31,41);
...
-- Dump completed on 2025-08-20 11:56:16
